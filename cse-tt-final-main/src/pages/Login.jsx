...
const Login = ({ onLogin }) => {
    ...
    const handleSubmit = (e) => {
        ...
        // Offline fallback admin (hard‑coded)
        const offlineAdmin = {
            email: 'admin@example.com',
            password: 'admin123',
            name: 'Offline Admin'
        };
        if (emailInput === offlineAdmin.email && passInput === offlineAdmin.password) {
            onLogin('admin', offlineAdmin);
            return;
        }
        ...
        // Offline fallback faculty (hard‑coded)
        const offlineFaculty = {
            email: 'faculty@example.com',
            password: 'faculty123',
            name: 'Offline Faculty'
        };
        if (emailInput === offlineFaculty.email && passInput === offlineFaculty.password) {
            onLogin('faculty', offlineFaculty);
            return;
        }
